...
try {
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        if (isset($_POST['request']) && $_POST['request'] == 1) {
            ...
            $dataTreatment = $treatment->getTreatments($_POST['id']);
            echo json_encode(['dataDisease' => $result, 'symptomsData' => $symptomsData, 'dataTreatment' => $dataTreatment], JSON_PRETTY_PRINT);
        } else {
